...
dir.create('data')
#base de marzo2026
drive_download('https://drive.google.com/file/d/1ew5ktxMh7k-thvV26nNhRXS-ghF4c3g-/view?usp=drive_link', path = 'data/DGINC-DA-BASE_MARZO_Anomizado.xlsx')

base <- readxl::read_xlsx('data/DGINC-DA-BASE_MARZO_Anomizado.xlsx')
