...
#base enero 2026
drive_download('https://docs.google.com/spreadsheets/d/1NZ1gk68De8YbGklXyjpnugUbRcQ7bJvd/edit?usp=sharing&ouid=118184938313502858180&rtpof=true&sd=true',
 path = 'data/clave Hortalez@2026 - CUD_vigentes_Juntas_CABA_2026_01 Anonimizado.xlsx')


base <- read.xlsx(
'data/clave Hortalez@2026 - CUD_vigentes_Juntas_CABA_2026_01 Anonimizado.xlsx',
#rows = 1:2,
#cols = 1:3,
#startRow = 2,
#colNames = FALSE)
