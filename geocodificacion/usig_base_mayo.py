...
base = pd.read_excel ('/home/marcos/Documents/discapacidad_caba/data/raw/dgippd/DGINC-BASE_MAYO_Recibida_16-6-2026.xlsx') 
...
base = base[base["domicilio"].notna()]
base["calle"] = base['domicilio'].astype(str).apply(limpiar_calle)
...
df.to_csv("data/processed/usig/usig_mayo.csv", encoding="utf-8")
...
df_final.to_csv("data/processed/usig/usig_mayo.csv", encoding="utf-8")
