...
base = pd.read_excel ('data/raw/dgippd/CUD vigentes residentes en CABA anonimizada 1-10-2025.xlsx') 
...
base[["domicilio","nro_de_domicilio"]].sample(20)

base["direccion_usig"] = (
    base["domicilio"] + " " +
    base["nro_de_domicilio"].astype(str) +
    ", CABA"
)
...
df.to_csv("data/processed/usig/usig_octubre25.csv", encoding="utf-8")
